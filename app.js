...
function groupCategoriesByTheme() {
  ...
  return [
      ...
      },
      {
          name: "Context",
          categories: [
              state.categories.find(cat => cat.id === "feasibility"),
              state.categories.find(cat => cat.id === "cultural_permissiveness_required"),
      ...
      },
      {
          name: "Resources",
          categories: [
              state.categories.find(cat => cat.id === "resource_requirement"),
              state.categories.find(cat => cat.id === "human_resource_skills"),
              state.categories.find(cat => cat.id === "technological_access_required")
          ]
      }
      // {
      //     name: "Methodology Qualities",
      //     categories: [
      //         state.categories.find(cat => cat.id === "participation"),
      //         state.categories.find(cat => cat.id === "validity"),
      //         state.categories.find(cat => cat.id === "reliability"),
      //         state.categories.find(cat => cat.id === "gender-transformative_potential"),
      //         state.categories.find(cat => cat.id === "inclusivity_of_marginalised_girls"),
      //         state.categories.find(cat => cat.id === "value_for_money"),
      //         state.categories.find(cat => cat.id === "behavioural_insight_integration")
      //     ]
      // }
  ];
}
...
// Function to update filtered methods based on user selections
